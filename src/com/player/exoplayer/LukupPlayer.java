 ...
 */
public class LukupPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     */
    void buildRenderers(LukupPlayer player, RendererBuilderCallback callback);
  }
  ...
  public interface RendererBuilderCallback {
     ...
     *
     * @param trackNames The names of the available tracks, indexed by {@link LukupPlayer} TYPE_*
     ...
     *     indexed by {@link LukupPlayer} TYPE_* constants. May be null if there are no types with
     *     multiple tracks. An individual element may be null if it does not have multiple tracks.
     * @param renderers Renderers indexed by {@link LukupPlayer} TYPE_* constants. An individual
  ...
  public LukupPlayer(RendererBuilder rendererBuilder) {
  ...
  public void prepare() {
    ...
    Log.i("LukupPlayer", "prepare  RENDERER_BUILDING_STATE_BUILDING");
  ...
  private void maybeReportPlayerState() {
	  Log.i("Lukupplayer", "maybeReportPlayerState()");
  ...
  private class InternalRendererBuilderCallback implements RendererBuilderCallback {
    ...
    public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
        TrackRenderer[] renderers) {
      if (!canceled) {
        LukupPlayer.this.onRenderers(trackNames, multiTrackSources, renderers);
      }
    }
    ...
    public void onRenderersError(Exception e) {
      if (!canceled) {
        LukupPlayer.this.onRenderersError(e);
      }
    }
